...
insert into payment_instrument (status, creation_date_time, account_holder) values (0, {ts '2014-12-15 9:41:11.564'}, 'Ghodrat Naderi');
set @payment_instrument_id = identity();

insert into bank_account (id, bank_name, iban, bic) values (@payment_instrument_id, 'AIB Bank', 'DE12500105170648489890', 'INGDDEFFXXX');
...
insert into payment_instrument (status, creation_date_time, account_holder) values (0, {ts '2014-11-11 11:11:11.111'}, 'Ghodrat Naderi');
set @payment_instrument_id = identity();
