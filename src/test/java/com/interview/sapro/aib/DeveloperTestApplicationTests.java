 ...
 * you may not use this file except in compliance with the LiLICENSEcense.
...
@SpringApplicationConfiguration(classes = SimpleBankEmployeesDashboardApplication.class)
@WebAppConfiguration
